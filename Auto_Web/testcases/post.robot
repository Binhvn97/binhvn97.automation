...
PO_22 Create a new data with the invalid "Tiêu đề" English tab field
    [Tags]                                                                                        Create                                      Button
    Create a category with "Cate1" name
    When Click "Tạo mới bài viết" button
    When Click "Trở lại" button
...
PO_23 Create a new data with the invalid "Tiêu đề" English tab field
    [Tags]                                                                                        Create                                      Button
    Create a category with "Cate1" name
    When Click "Tạo mới bài viết" button
    When Click on the left arrow icon
...
PO_47 Verify the changing with the existed "Tiêu đề"
...
PO_48 Verify the delete data function
...
PO_49 Verify the cancel action button when delete data
    [Tags]                                                                                        Delete
    Create a category with "Cate1" name 
    Create a test post with "Cate1" type
    When Select on the "Cate1" item line
